...
# Update all reports to have reporter_name = 'ทนพ.มานพ นันตาบุตร' and approver_name = 'ทนพญ.นริศรา มังกรแก้ว'
...
try:
    with urllib.request.urlopen(req) as resp:
        ...
        print(f"✅ Successfully updated {len(updated_data)} reports in Supabase!")
        print("Sample updated records:")
        for r in updated_data[:3]:
            print(f"  - {r['submission_no']} | Reporter: {r['reporter_name']} | Approver: {r['approver_name']}")
