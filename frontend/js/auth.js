...
const DEPARTMENT_ACCOUNTS = {
  ...
  'compounding': {
    ...
    serviceCode: 'DRG_07',
    serviceName: 'Drug (สำหรับงานผลิตยา) ปลอดเชื้อ',
    defaultRedirect: 'workflow.html?tab=submission&service=DRG_07',
    role: 'department_staff',
    roleTitle: 'เภสัชกร/เจ้าหน้าที่งานผลิตยา',
    displayName: 'งานผลิตยา (ยาปลอดเชื้อ)',
    icon: 'fa-capsules',
  ...
  'pharma': {
    ...
    department: 'ยาผลิตปราศจากเชื้อ',
    serviceCode: 'DRG_08',
    serviceName: 'Drug (สำหรับยาผลิตปราศจากเชื้อ) การปนเปื้อนเชื้อจุลินทรีย์',
    defaultRedirect: 'workflow.html?tab=submission&service=DRG_08',
    role: 'department_staff',
    roleTitle: 'เภสัชกร/เจ้าหน้าที่ยาผลิตปราศจากเชื้อ',
    displayName: 'ยาผลิตปราศจากเชื้อ (การปนเปื้อนเชื้อจุลินทรีย์)',
    icon: 'fa-flask',
